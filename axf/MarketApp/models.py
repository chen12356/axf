...
class Axf_foodtype(models.Model):
...
'''
INSERT INTO axf_goods (id, productid, productimg, productname, productlongname, isxf, pmdesc,
 specifics, price, marketprice, categoryid, childcid, childcidname, dealerid, 
 storenums, productnum) VALUES (1, 11951, '/media/images/goods016.jpg', '', '乐吧薯片鲜虾味50.0g', 0, 0,
  '50g', 2, 2.5, 103541, 103543, '膨化食品', 4858, 200, 4);
'''
